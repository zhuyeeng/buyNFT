...
describe("NumberGame tests set #1", function () {
    ...
    describe("makeGuess and finalizeGame", function () {
        ...
        it("should correctly distribute rewards to winner (** Modify numberGenerator to winning condition)", async function () {
            const gameTx = await numberGame.createGame();
            const gameId = (await gameTx.wait()).events[0].args.gameId;
...
describe("NumberGame tests set #2", function () {
    ...
    describe("withdraw", function () {
        ...
        it("should resist reentrancy attacks (** test Not yet implemented)", async function () {
